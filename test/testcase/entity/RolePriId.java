...
public class RolePriId  implements java.io.Serializable {
    ...
    /** full constructor */
    public RolePriId(TRole TRole, TPrivilege TPrivilege) {
        this.TRole = TRole;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof RolePriId) ) return false;
 ...
 && ( (this.getTPrivilege()==castOther.getTPrivilege()) || ( this.getTPrivilege()!=null && castOther.getTPrivilege()!=null && this.getTPrivilege().equals(castOther.getTPrivilege()) ) );
   }
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getTPrivilege() == null ? 0 : this.getTPrivilege().hashCode() );
         return result;
   }   
