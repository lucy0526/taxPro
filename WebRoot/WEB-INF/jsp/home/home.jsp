            ...
            <table width="98%" border="0" align="center">
                <tr>
                    <td width="76" height="100" align="center" valign="middle">
                        <div class="left-tx">
                            <s:if test="%{#session.SYS_USER.headImage != null && #session.SYS_USER.headImage != ''}">
                            	<img src="${ctx}/upload/<s:property value="#session.SYS_USER.headImage"/>" width="70" height="70" />
                            </s:if>
                            <s:else>
        ...
        <div class="left_grzx1">
            ...
            <table width="98%" border="0" align="center">
            	<s:iterator value="#infoList">
	                <tr>
	                    <td height="23">
	                    	<s:url var="infoViewUI" action="home_infoViewUI" namespace="/sys">
	                    		<s:param name="info.infoId">
        ...
        <div class="lc_grzx1">
            ...
            <table width="98%" border="0" align="center">
                <s:iterator value="#complainList">
	                <tr>
	                    <td height="23">
	                    	<s:url var="complainViewUI" action="home_complainViewUI" namespace="/sys">
	                    		<s:param name="comp.compId">
	                    			<s:property value="compId"/>
	                    		</s:param>
	                    	</s:url>
	                    	<s:a href="%{#complainViewUI}" target="_blank">
	                    ...
	                    <td width="180px">
	                    	<s:property value="isNm?'匿名投诉':'非匿名投诉'"/>
	                    </td>
	                    <td width="180px">
	                    	<s:date name="compTime" format="yyyy-MM-dd HH:mm"/>
	                    </td>
	                </tr>
                </s:iterator>
            </table>
